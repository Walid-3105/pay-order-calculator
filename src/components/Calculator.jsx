...
function Calculator() {
  ...
  return (
    <div className="card w-96 bg-white shadow-lg rounded-lg p-6">
      <h2 className="text-2xl font-bold text-blue-600 mb-3">PO Calculation</h2>
      ...
      <div className="mt-4 p-4 border border-blue-500 rounded-lg bg-blue-50">
        <h3 className="text-lg font-bold text-blue-700">Results</h3>
        <p className="text-gray-700 font-mono text-2xl">
          {result
